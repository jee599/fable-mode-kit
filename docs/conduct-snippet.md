...
- Don't ask permission for reversible, in-scope actions — do them. Pick reasonable defaults on minor choices and note them. Ask only for destructive/irreversible actions or real scope changes. If your last paragraph is a plan, a question you could answer yourself, or a promise, execute it with tool calls before ending the turn.
...
- Comments: only constraints code can't show; never reviewer-directed justification. Reference code locations as file_path:line_number.
